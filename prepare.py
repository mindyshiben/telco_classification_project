...
def prep_telco(df):
    ...
    dummy = pd.get_dummies(df[['gender', 'partner', 'dependents', 'phone_service', 'multiple_lines',
                  ...
                  'churn', 'internet_service_type', 'payment_type', 'contract_type']], prefix= (['encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_', 'encoded_']),
